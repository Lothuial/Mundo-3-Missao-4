...
public class Pessoa implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "fKPessoaid")
    ...
    public Pessoa(Integer idPessoa, String nome, String endereco, String cidade, String estado, String email, String telefone) {
        this.idPessoa = idPessoa;
        this.nome = nome;
